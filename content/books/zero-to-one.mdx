...
- You should always plan to be the last mover in your space/think about how you can achieve this. How can you create something so good that no one else can replace you?1
